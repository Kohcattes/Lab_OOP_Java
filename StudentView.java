...
public class StudentView extends javax.swing.JFrame implements WindowListener{
    ...
    private void initComponents() {
        ...
        jTextField3.setText(stu.getMoney()+"");
    ...
    public void windowOpened(WindowEvent e) {
        ...
        jTextField1.setText(String.valueOf(stu.getId()));
        jTextField2.setText(stu.getName());
        jTextField3.setText(String.valueOf(stu.getMoney()));
    }
    public void windowClosing(WindowEvent e) {
        stu.setId(Integer.parseInt(jTextField1.getText()));
        stu.setName(jTextField2.getText());
        stu.setMoney(Integer.parseInt(jTextField3.getText()));
        try {
